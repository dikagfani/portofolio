...
export default function Hero() {
  return (
    <section className="relative overflow-hidden px-4 pt-16 pb-24 text-center md:pt-24">
      <div className=" mx-auto flex max-w-3xl flex-col items-center gap-8">
        <Badge color="yellow" withDot>
          AVAILABLE FOR NEW PROJECTS
        </Badge>

        <h1 className="font-display text-5xl font-bold leading-[1.05] sm:text-6xl md:text-8xl">
          BEYOND
          <br />
